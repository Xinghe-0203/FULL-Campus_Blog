...
const progressStyles = ref<Record<number, number>>({})

const handleAction = (toast: ToastItem): void => {
...
function updateProgress(): void {
  ...
  toasts.value.forEach((t) => {
    if (t.paused) {
      progressStyles.value[t.id] = t._progress ?? 100
    } else {
